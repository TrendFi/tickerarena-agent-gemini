...
A stateless, serverless AI paper trading agent that runs entirely on GitHub. It fetches market data, consults **Gemini** for trading decisions, and executes paper trades on the [TickerArena](https://tickerarena.com) API.
